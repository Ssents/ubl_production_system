...
urlpatterns = [
    ...
    path('daily-tonage-search/', views.SearchDailyTonageView.as_view(),
        name="daily_tonage_search"),
    path('reconsiliation-search/', views.SearchMonthlyReconsiliationView.as_view(),
        name="reconsiliation_search"),
]